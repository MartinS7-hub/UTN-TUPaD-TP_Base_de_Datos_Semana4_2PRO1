...
-- HEREDADO Semanas 3 y 4 — SIN MODIFICAR. Fuente de la carga de trabajo real a indexar.
...
--
-- Consultas analíticas adicionales (base del plan de indexado Semana 5)
--
...
-- F) [Semana 5] Reporte mensual de pedidos confirmados (consulta objetivo del índice 1)
...
-- G) [Semana 5] Listado de productos por categoría ordenado por precio (consulta objetivo del índice 3)
